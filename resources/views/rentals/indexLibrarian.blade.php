...
<div class="container mx-auto p-8">
    <div class="bg-white p-6 rounded-lg shadow">
        <h2 class="text-2xl font-bold mb-4">Rental List</h2>
        ...
        <div>
            ...
            <ul>
                ...
                <li class="mb-6">
                    ...
                    <a href="{{ route('librarianRentalDetails', $rental->id) }}" class="block text-blue-500 hover:text-blue-600">View Details</a>
                </li>
                @endforeach
            </ul>
            @endif
